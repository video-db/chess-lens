#!/usr/bin/env tsx
/**
 * tools/diagnostics/checkModelAvailability.ts
 *
 ...
 *
 * Usage:
 *   npx tsx tools/diagnostics/checkModelAvailability.ts <apiKey> <sessionId> [apiUrl]
 *
...
import { RTSTREAM_VISION_MODEL } from '../../src/main/services/llm/llm.service';
...
async function main(): Promise<void> {
  ...
  if (args.length < 2 || args[0] === '--help' || args[0] === '-h') {
    console.log('Usage: npx tsx tools/diagnostics/checkModelAvailability.ts <apiKey> <sessionId> [apiUrl]');
    console.log('');
