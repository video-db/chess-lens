#!/usr/bin/env tsx
/**
 * tools/diagnostics/benchmarkChess.ts
 *
 ...
 * Usage:
 * 
 *   npx tsx tools/diagnostics/benchmarkChess.ts <apiKey> [apiUrl]
 *
 * Output:
 *   Console report (FEN section + Turn section) + tools/diagnostics/benchmark-results.json
 */
...
async function main(): Promise<void> {
  ...
  if (!args[0] || args[0] === '--help' || args[0] === '-h') {
    console.log('Usage: npx tsx tools/diagnostics/benchmarkChess.ts <apiKey> [apiUrl]');
