 ...
 *   npx tsx tools/diagnostics/simulatePipelineLatency.ts
 *
 *   # Fast path (single read, no second read)
 *   npx tsx tools/diagnostics/simulatePipelineLatency.ts --fast
 *
 *   # Custom timings
 *   npx tsx tools/diagnostics/simulatePipelineLatency.ts --fenExtract1 4300 --engineCall 700 --coachingLLM 4200
 *
 *   # Fast path with a turn timeout
 *   npx tsx tools/diagnostics/simulatePipelineLatency.ts --fast --turnTimedOut
 *
 *   # Fast path with a FEN retry
 *   npx tsx tools/diagnostics/simulatePipelineLatency.ts --fast --fenRetried
 */
...
Examples:
npx tsx tools/diagnostics/simulatePipelineLatency.ts --fast --fenExtract1 12000 --coachingLLM 3500
npx tsx tools/diagnostics/simulatePipelineLatency.ts --slow --fenExtract1 12000 --fenExtract2 11500
`);
}
