 ...
 *   npx tsx tools/analyzeLatencyLogs.ts path/to/app-YYYY-MM-DD.log
 *
 *   # From multiple files
 *   npx tsx tools/analyzeLatencyLogs.ts logs/app-*.log
 *
 *   # Pipe live dev output  (strip pino-pretty ANSI codes first)
 *   npm run dev 2>&1 | npx tsx tools/analyzeLatencyLogs.ts --stdin
 *
 *   # From Electron userData logs directory (auto-detected)
 *   npx tsx tools/analyzeLatencyLogs.ts --auto
 */
