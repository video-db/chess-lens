...
function QuestionIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="10" cy="10" r="7.5" stroke="var(--color-chat-coach-border)" strokeWidth="1.5" />
      <path
        d="M7.5 7.5C7.5 6.11929 8.61929 5 10 5C11.3807 5 12.5 6.11929 12.5 7.5C12.5 8.88071 11.3807 10 10 10V11.25"
        stroke="var(--color-chat-coach-border)"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      <circle cx="10" cy="14" r="0.75" fill="var(--color-chat-coach-border)" />
    </svg>
  );
}
  ...
  return (
    <div
      style={{
        ...
        background: 'var(--color-chat-coach-border)',
        display: 'flex',
        alignItems: 'center',
